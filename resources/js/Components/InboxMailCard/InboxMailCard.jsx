            ...
            <div className="flex-1 min-w-0 ">
                ...
                >
                    <div className="flex items-center gap-2 min-w-0 flex-wrap">
                        ...
                        <div
                            id="mail-card-serial"
                            className="text-sm font-bold truncate max-w-20 sm:max-w-[120px]"
                        >
                            {card.radicado || card.id}
                        </div>
                        <div
                            className={`text-xs px-1 rounded ${card.type === 'entrada' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'}`}
                        >
                            {card.type === 'entrada' ? 'RE' : 'ENV'}
                        </div>
