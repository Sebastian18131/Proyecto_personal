        ...
        >
            ...
            <div className="flex-1 overflow-y-auto p-6 pb-[50px] md:pb-6 space-y-5">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className={`px-3 py-1 text-white text-xs font-bold rounded-full uppercase tracking-wide ${currentMail.type === 'entrada' ? 'bg-blue-500' : 'bg-green-500'}`}>
                        {currentMail.type === 'entrada' ? 'Entrada (RE)' : 'Salida (ENV)'}
                    </span>
                    <span className="text-sm font-bold text-gray-700">
                        Radicado: {currentMail.radicado || 'N/A'}
                    </span>
                    <span className="text-sm text-gray-400 font-medium">
                        Año: {currentMail.year}
                    </span>
